...
public class XESHandlerBPIC_12 extends DefaultHandler {
	 ...
	 */
	 ...
	 private String activityName = null;
	   ...
	   private Map<String, Integer> activityNameShortenerCache = new HashMap<>();
	   	  private int shorterReplacementCurrent = 0;
			   ...
			   String localName, String qName)
	   {
		   ...
		   else if(qName.equals("event"))
		   {
			   ...
			   if(shouldBeStored)
			   {
				   Integer shorterReplacement = activityNameShortenerCache.get(activityName);
				   if(shorterReplacement == null)
				   {	
					   shorterReplacement=shorterReplacementCurrent++;
					   activityNameShortenerCache.put(activityName, shorterReplacement);
				   }
				   activityName=shorterReplacement.toString();
